...
public class Turret extends SubsystemBase{
    ...
    private double getTangentialVelocity(double velocityX, double velocityY) {
        ...
        var angleToHub =  Math.toRadians(getAngleToPosition());
    ...
    public Command aimWaist(Translation2d towards) {
        ...
        var angle =  getAngleFromRobotToPosition(towards) + RobotContainer.kNavx.getYaw();
        ...
        //var phantomPitchPosition = T * (tangVelocity + robotRotationalTangVelocity) * Math.cos(90 - getAngleToPosition());

        //clamping the value because our turret only goes 360 degrees exactly
        angle = MathUtil.clamp(angle % 360, 0, 360);
